...
- **Master Ball**: hatching also has a small, independent chance to drop one. Spend it and it tells you which sub-legendary, legendary or mythical Pokémon you will get — 60/30/10 odds across the three tiers, with the same 5% chance of it being shiny as any other reveal — but it still opens as a fresh, unhatched Pokéball of that species you have to raise, same as any other catch (whatever was out is tucked away first, progress and all).
