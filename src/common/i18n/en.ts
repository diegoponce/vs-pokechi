...
export const en: Strings = {
  ...
  itemDescriptions: {
    'rare-candy': 'Instantly evolves your current pokemon, as long as it is not already fully evolved.',
    'master-ball': 'Reveals a random sub-legendary, legendary or mythical Pokémon from any generation.',
    'premier-ball': 'Reveals a random Pokémon as shiny, from any generation or rarity.',
  },
  typeAbbreviations: {
    normal: 'NOR',
    fire: 'FIR',
  ...
  hatchMessage: (name, cry, dropNote) => `${name} hatched from the Pokéball! ${cry}${dropNote}`,
  ...
  explorerModeChanged: 'Pokechi mode changed to explorer. Look for Pokechi in the Explorer view!',
  ...
  candyCounterNotUsableNow: (itemName) => `Your current pokemon cannot use a ${itemName} right now`,
