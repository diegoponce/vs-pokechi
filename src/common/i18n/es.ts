...
export const es: Strings = {
  ...
  itemDescriptions: {
    'rare-candy': 'Evoluciona al instante a tu pokémon actual, siempre que no esté ya completamente evolucionado.',
    'master-ball': 'Revela un Pokémon sub-legendario, legendario o mítico al azar de cualquier generación.',
    'premier-ball': 'Revela un Pokémon al azar como shiny, de cualquier generación o rareza.',
  },
  ...
  hatchMessage: (name, cry, dropNote) => `¡${name} eclosionó de la Poké Ball! ${cry}${dropNote}`,
  ...
  pokedexSnapshotCatchAgain: ' Atrápalo de nuevo para seguir criando esa línea.',
  ...
  explorerModeChanged: 'El modo de Pokechi cambió a explorador. ¡Busca a Pokechi en la vista del Explorador!',
