...
export const ja: Strings = {
  ...
  itemDescriptions: {
    'rare-candy': '手持ちのポケモンが完全に進化していなければ、即座に進化させる。',
    'master-ball': '全世代からランダムに準伝説・伝説・幻のポケモンを1匹表示する。',
    'premier-ball': '全世代・レア度からランダムなポケモンを色違いとして表示する。',
  },
  ...
  hatchMessage: (name, cry, dropNote) => `${name}がモンスターボールから孵化した！${cry}${dropNote}`,
  ...
  pokedexSnapshotMessage: (name) => `ここに表示されているのは${name}の最大到達形態です。`,
  pokedexSnapshotCatchAgain: ' このラインを育て続けるには、もう一度捕まえてください。',
  pokedexSnapshotCatchShiny: ' このラインを育て続けるには、色違いで捕まえてください。',
  ...
  explorerModeChanged: 'Pokechiのモードがエクスプローラーに切り替わりました。エクスプローラービューでPokechiを探してください！',
