...
export const fr: Strings = {
  ...
  itemDescriptions: {
    'rare-candy': 'Fait évoluer instantanément ton pokémon actuel, tant qu\'il n\'est pas déjà totalement évolué.',
    'master-ball': 'Révèle un Pokémon sous-légendaire, légendaire ou mythique aléatoire, toutes générations confondues.',
    'premier-ball': 'Révèle un Pokémon aléatoire en shiny, toutes générations et raretés confondues.',
  },
  ...
  hatchMessage: (name, cry, dropNote) => `${name} est sorti de la Poké Ball ! ${cry}${dropNote}`,
  ...
  couldNotBringOut: (pokemonType) => `Impossible de faire sortir ${pokemonType}.`,
  pokedexSnapshotMessage: (name) => `${name} est affiché ici au maximum.`,
  pokedexSnapshotCatchAgain: ' Capture-le à nouveau pour continuer à élever cette lignée.',
  pokedexSnapshotCatchShiny: ' Capture-le en shiny pour continuer à élever cette lignée.',
  ...
  explorerModeChanged: 'Le mode de Pokechi est passé en explorateur. Cherche Pokechi dans la vue Explorateur !',
