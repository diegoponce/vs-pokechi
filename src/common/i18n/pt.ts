...
export const pt: Strings = {
  ...
  itemDescriptions: {
    'rare-candy': 'Evolui instantaneamente seu pokémon atual, desde que ele ainda não esteja totalmente evoluído.',
    'master-ball': 'Revela um Pokémon sub-lendário, lendário ou mítico aleatório de qualquer geração.',
    'premier-ball': 'Revela um Pokémon aleatório como shiny, de qualquer geração ou raridade.',
  },
  typeAbbreviations: {
    normal: 'NOR',
    fire: 'FOG',
  ...
  hatchMessage: (name, cry, dropNote) => `${name} eclodiu da Poké Bola! ${cry}${dropNote}`,
  ...
  pokedexSnapshotMessage: (name) => `${name} está sendo mostrado no máximo aqui.`,
  pokedexSnapshotCatchAgain: ' Capture-o novamente para continuar criando essa linha.',
  pokedexSnapshotCatchShiny: ' Capture-o shiny para continuar criando essa linha.',
  ...
  explorerModeChanged: 'O modo do Pokechi mudou para explorador. Procure o Pokechi na visão do Explorer!',
