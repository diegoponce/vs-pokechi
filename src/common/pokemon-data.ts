...
export const POKEMON_DATA: { [key: string]: PokemonConfig } = {
  ...
  torterra: {
    ...
    cry: 'Torterra!',
    possibleColors: [PokemonColor.default, PokemonColor.shiny],
    types: [PokemonElementType.grass, PokemonElementType.ground],
  },
  chimchar: {
    id: 390,
    name: 'Chimchar',
  ...
  empoleon: {
    ...
    cry: 'Empoleon!',
    possibleColors: [PokemonColor.default, PokemonColor.shiny],
    types: [PokemonElementType.water, PokemonElementType.steel],
  },
  starly: {
    id: 396,
    name: 'Starly',
  ...
  bibarel: {
    ...
    cry: 'Bibarel!',
    possibleColors: [PokemonColor.default, PokemonColor.shiny],
    types: [PokemonElementType.normal, PokemonElementType.water],
  },
  kricketot: {
    id: 401,
    name: 'Kricketot',
  ...
  shieldon: {
    ...
    possibleColors: [PokemonColor.default, PokemonColor.shiny],
    rarity: PokemonRarity.fossil,
    types: [PokemonElementType.rock, PokemonElementType.steel],
  },
  bastiodon: {
    id: 411,
    name: 'Bastiodon',
  ...
  drifloon: {
    ...
    cry: 'Drifloon!',
    possibleColors: [PokemonColor.default, PokemonColor.shiny],
    types: [PokemonElementType.ghost, PokemonElementType.flying],
  },
  drifblim: {
    id: 426,
    name: 'Drifblim',
  ...
  stunky: {
    ...
    cry: 'Stunky!',
    possibleColors: [PokemonColor.default, PokemonColor.shiny],
    types: [PokemonElementType.poison, PokemonElementType.dark],
  },
  skuntank: {
    id: 435,
    name: 'Skuntank',
  ...
  spiritomb: {
    ...
    cry: 'Spiritomb!',
    possibleColors: [PokemonColor.default, PokemonColor.shiny],
    types: [PokemonElementType.ghost, PokemonElementType.dark],
  },
  gible: {
    id: 443,
    name: 'Gible',
    ...
    cry: 'Gible!',
    possibleColors: [PokemonColor.default, PokemonColor.shiny],
    types: [PokemonElementType.dragon, PokemonElementType.ground],
  },
  gabite: {
    id: 444,
    name: 'Gabite',
  ...
  lucario: {
    ...
    cry: 'Lucario!',
    possibleColors: [PokemonColor.default, PokemonColor.shiny],
    types: [PokemonElementType.fighting, PokemonElementType.steel],
  },
  hippopotas: {
    id: 449,
    name: 'Hippopotas',
  ...
  skorupi: {
    ...
    cry: 'Skorupi!',
    possibleColors: [PokemonColor.default, PokemonColor.shiny],
    types: [PokemonElementType.poison, PokemonElementType.bug],
  },
  drapion: {
    id: 452,
    name: 'Drapion',
  ...
  croagunk: {
    ...
    cry: 'Croagunk!',
    possibleColors: [PokemonColor.default, PokemonColor.shiny],
    types: [PokemonElementType.poison, PokemonElementType.fighting],
  },
  toxicroak: {
    id: 454,
    name: 'Toxicroak',
  ...
  snover: {
    ...
    cry: 'Snover!',
    possibleColors: [PokemonColor.default, PokemonColor.shiny],
    types: [PokemonElementType.grass, PokemonElementType.ice],
  },
  abomasnow: {
    id: 460,
    name: 'Abomasnow',
  ...
  gallade: {
    ...
    cry: 'Gallade!',
    possibleColors: [PokemonColor.default, PokemonColor.shiny],
    types: [PokemonElementType.psychic, PokemonElementType.fighting],
  },
  probopass: {
    id: 476,
    name: 'Probopass',
  ...
  froslass: {
    ...
    cry: 'Froslass!',
    possibleColors: [PokemonColor.default, PokemonColor.shiny],
    types: [PokemonElementType.ice, PokemonElementType.ghost],
  },
  rotom: {
    id: 479,
    name: 'Rotom',
    ...
    cry: 'Rotom!',
    possibleColors: [PokemonColor.default, PokemonColor.shiny],
    types: [PokemonElementType.electric, PokemonElementType.ghost],
  },
  rotom_fan: {
    id: 479,
    name: 'Rotom (Fan)',
  ...
  dialga: {
    ...
    rarity: PokemonRarity.legendary,
    originalSpriteSize: 64,
    types: [PokemonElementType.steel, PokemonElementType.dragon],
  },
  palkia: {
    id: 484,
    name: 'Palkia',
  ...
  heatran: {
    ...
    possibleColors: [PokemonColor.default, PokemonColor.shiny],
    rarity: PokemonRarity.legendary,
    types: [PokemonElementType.fire, PokemonElementType.steel],
  },
  regigigas: {
    id: 486,
    name: 'Regigigas',
  ...
  giratina: {
    ...
    rarity: PokemonRarity.legendary,
    originalSpriteSize: 64,
    types: [PokemonElementType.ghost, PokemonElementType.dragon],
  },
  giratina_origin: {
    id: 487,
  ...
  arceus_flying: {
    ...
    rarity: PokemonRarity.mythical,
    originalSpriteSize: 64,
    types: [PokemonElementType.flying],
  },
  arceus_ghost: {
    id: 493,
    name: 'Arceus (Ghost)',
